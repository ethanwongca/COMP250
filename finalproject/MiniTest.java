...
class MiniTest {
    ...
    public void RatingDistributionBySchoolTest() {
        ...
        String key1 = "amber  donahue" + "\n" + "3.63";
        String key2 = "david  burke" + "\n" + "4.33";
        assertEquals(8, dist.get(key1));
    ...
    public void GenderByKeyword() {
        ...
        assertEquals(438, dist.get("F"));
        assertEquals(7, dist.get("X"));
        assertEquals(399, dist.get("M"));
    ...
    public void RatingByKeyword() {
        ...
        assertEquals(167, dist.get("1"));
        assertEquals(40, dist.get("2"));
        assertEquals(21, dist.get("3"));
        assertEquals(10, dist.get("4"));
        assertEquals(14, dist.get("5"));
    }
    ...
    public void RatingByGender() {
        ...
        assertEquals(2022, dist.get("2"));
        assertEquals(1916, dist.get("1"));
        assertEquals(2441, dist.get("3"));
        assertEquals(1817, dist.get("4"));
        assertEquals(1260, dist.get("5"));
    }
